    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="space-y-1.5 text-left text-muted-foreground sm:text-base">
          ...
          <p>
            Cada reto usa palabras de <strong>5 letras</strong>. Tendrás{" "}
            <strong>6 intentos</strong> para descubrirla.
          </p>
        ...
        <ul className="space-y-1 text-left text-muted-foreground sm:text-base">
          <li>
            <span className="font-semibold text-emerald-600">Verde:</span> La
            letra es correcta y está bien ubicada.
          </li>
          <li>
            <span className="font-semibold text-amber-600">Amarillo:</span> La
            letra es correcta pero está en otra posición.
          </li>
          <li>
            <span className="font-semibold text-zinc-600">Gris:</span> La letra
            no está en la palabra.
          </li>
        </ul>

        <p className="text-left text-muted-foreground sm:text-base">
          Mantén la racha jugando días consecutivos: mientras la racha siga
          activa recibes <strong>+1 punto</strong> extra por cada reto
          completado. Ya no hay penalización por inactividad.
        </p>
        <p className="text-left text-muted-foreground sm:text-base">
